...
class EditStudentRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            //
            'student_image'=>'image', //bail
            'student_name'=>'required|min:5|max:30|unique:students,student_name,'.$this->id.',student_id',
            'student_age'=>'required',
            'student_class'=>'required|min:5|max:50',
            'student_class_teacher'=>'required|min:5|max:50',
    ...
    public function messages()
    {
        return [
           ...
           'student_name.required'=>':attribute không được để trống',
         ...
         //'student_class.required'=>':attribute không được để trống',
           ...
           'student_class_teacher.alpha'=>':attribute  không đúng định dạng',  
